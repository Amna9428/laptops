...
const topProducts = [
  ...
  { id: 6, name: "Google Pixel 8 Pro", sales: "$120,000", orders: "160,000", price: "$899" },
  { id: 7, name: "Xiaomi 14 Pro", sales: "$100,000", orders: "140,000", price: "$749" },
  { id: 8, name: "Google Pixel 8 Pro", sales: "$120,000", orders: "160,000", price: "$899" },
  { id: 9, name: "Xiaomi 14 Pro", sales: "$100,000", orders: "140,000", price: "$749" },
